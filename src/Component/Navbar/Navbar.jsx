...
const Navbar = ({userData ,setUserdata ,logOut}) => {
  return(
    <>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul className="navbar-nav d-flex align-items-center ms-auto mb-2 mb-lg-0">
        ...
        {userData?<>
          ...
          <a  href='https://mail.google.com/mail/u/0/#inbox'><i className="fa-brands fa-google mx-2"></i></a>
        ...
        <li className="nav-item">
          <span className="logout nav-link active" onClick={logOut} aria-current="page">Logout</span>
      </li>
      <Link to='profile'><i className="fa-solid fa-user rounded-circle border mx-3 p-2"></i></Link>

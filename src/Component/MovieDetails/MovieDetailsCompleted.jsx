...
{movieDetails? <div className="row">
   <div className="col-md-4 d-flex align-items-center ">
       ...
       <img src={movieDetails.poster_path?"https://image.tmdb.org/t/p/w500"+movieDetails.poster_path:"https://image.tmdb.org/t/p/w500"+movieDetails.backdrop_path} className="w-100 h-100" alt="img" />
   </div>
   <div className="col-md-8">
       <h1 className=' mb-3'>{movieDetails.name}</h1>
       <h1 className=' mb-3'>{movieDetails.original_title}</h1>
       <button type="button" className="btn mx-1 btn-primary">Crime</button>
       <button type="button" className="btn mx-1 btn-secondary">Drama</button>
       <button type="button" className="btn mx-1 btn-success">Mystery</button> 
